export class TestValues {
  ...
  static SUB_DESCRIPTION =
    "ome standard status codes you will run into include but are not limited to:";

  static STATUS_CODES = ["200", "301", "404", "500"];
  static SUCCESS_CODE_PAGE_HEADER = `This page returned a 200 status code.`;
}
